...
-- Exportiere Daten aus Tabelle gebaeudemanagement.dezernatmitarbeiter: ~17 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle gebaeudemanagement.leistungsspektren1: ~10 rows (ungefähr)
/*!40000 ALTER TABLE `dezernatmitarbeiter` DISABLE KEYS */;
INSERT INTO `leistungsspektren1` (`lsp_id`, `lsp_dlr_id`) VALUES
    (1,1), (2,2), (3, 3), (4, 4), (5, 4), (6, 5), (7, 6), (8, 1), 
    (9, 6), (10, 7), (11, 8), (12, 8), (13, 9), (14, 10), (15, 8);
/*!40000 ALTER TABLE `leistungsprektren1` ENABLE KEYS */;
...
INSERT INTO `lnLspDln` (`lld_id`, `lld_lsp_id`, `lld_dln_id`, `lld_preis`) VALUES
    (1, 1, 1, 200), (2, 1, 2, 20000), (3, 1, 3, 50),
    (4, 2, 4, 200), (5, 2, 7, 550), (6, 2, 8, 500),
    (7, 3, 5, 80), (8, 3, 6, 120), (9, 3, 9, 1350),
    (10, 4, 1, 270), (11, 4, 2, 18500), (12, 4, 3, 50), (13, 4, 4, 200), (14, 4, 5, 100), (15, 4, 6, 132),
    (16, 5, 7, 530), (17, 5, 8, 525), (18, 5, 9, 1250), (19, 5, 12, 1360),
    (20, 10, 3, 50), (21, 10, 4, 200) ,(22, 10, 5, 85), (23, 10, 6, 133), (24, 10, 7, 525),
    (25, 8, 3, 50), (26, 8, 4, 199), (27, 8, 5, 75), (28, 8, 6, 145),
    (29, 15, 12, 1500);  
