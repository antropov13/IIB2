...
-- Exportiere Daten aus Tabelle IIB2_UE2_Gruppe09.dienstleister: ~10 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle IIB2_UE2_Gruppe09.dienstleistungen: ~12 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle IIB2_UE2_Gruppe09.dezernatmitarbeiter: ~10 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle IIB2_UE2_Gruppe09.leistungsspektren: ~10 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle IIB2_UE2_Gruppe09.lnLspDln: ~29 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle IIB2_UE2_Gruppe09.auftraege: ~4 rows (ungefähr)
...
(2, 1,1,1,1,'2018-01-01', 'Erledigt', 1),
(3, 1,4,1,4,'2018-05-07','Warte auf eine Antwort', 2),
(4, 3,4,3,4, '2018-05-07','Erledigt', 3);
/*!40000 ALTER TABLE `auftraege` ENABLE KEYS */;


-- Exportiere Daten aus Tabelle IIB2_UE2_Gruppe09.auftraege: ~5 rows (ungefähr)
/*!40000 ALTER TABLE `auftraege` DISABLE KEYS */;

INSERT INTO `auftraege` (`aft_id`,`aft_dma_id`, `aft_dlr_id`, `aft_dmadlr_id`, `aft_dlrdma_id`, `aft_datum`, `aft_status`,  `aft_geb_id`) VALUES
(5, 4,7,4,7,'2018-01-01', 'Abgelehnt', 4),
(6, 2,8,2,8,'2018-05-01', 'Abgelehnt', 4),
(7, 7,2,7,2,'2018-05-07', 'Warte auf eine Antwort', 5),
(8, 3,1,3,1,'2018-05-07', 'Warte auf eine Antwort', 2),
(9, 4,1,4,1, '2018-05-07', 'Abgelehnt', 3);
/*!40000 ALTER TABLE `auftraege` ENABLE KEYS */;


-- Exportiere Daten aus Tabelle IIB2_UE2_Gruppe09.lnAftDln: ~13 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle IIB2_UE2_Gruppe09.lndokumentiert: ~2 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle IIB2_UE2_Gruppe09.wand: ~27 rows (ungefähr)
/*!40000 ALTER TABLE `wand` DISABLE KEYS */;
INSERT INTO `wand`(`wan_id`, `wan_guid`, `wan_rau_id`) VALUES
    (1, '2', 1),
    (2, '3', 1),
    (3, '7', 1),
    (4, '8', 2),
...
-- Exportiere Daten aus Tabelle IIB2_UE2_Gruppe09.gebaeude: ~ 9 rows (ungefähr)
/*!40000 ALTER TABLE `gebaeude` DISABLE KEYS */;
INSERT INTO `gebaeude`(`geb_id`,`geb_strasse`, `geb_hausnr`, `geb_ort`,
            `geb_plz`, `geb_dma_id`, `geb_guid`) VALUES
(1, 'Hauptstr.', 1, 'Darmstadt', 64287, 1, NULL),
(2, 'Hauptstr.', 2, 'Frankfurt', 64287, 2, NULL),
(3, 'Hauptstr.', 3, 'Mainz', 64287, 3, NULL),
(4, 'Hauptstr.', 4, 'Darmstadt', 64287, 3, NULL),
(5, 'Hauptstr.', 5, 'Frankfurt', 64287, 3, NULL),
(6, 'Hauptstr.', 6, 'Wiesbaden', 64287, 4, NULL),
(7, 'Hauptstr.', 7, 'Darmstadt', 64287, 5, NULL),
(8, 'Hauptstr.', 8, 'Mainz', 64287, 6, NULL),
(9, 'Hauptstr.', 9, 'Darmstadt', 64287, 7, NULL);
/*!40000 ALTER TABLE `gebaeude` ENABLE KEYS */;


-- Exportiere Daten aus Tabelle IIB2_UE2_Gruppe09.stockwewrk: ~6 rows
/*!40000 ALTER TABLE `stockwerk` DISABLE KEYS */;
INSERT INTO `stockwerk`(`stw_id`,`stw_bezeichnung`, `stw_guid`, `stw_geb_id`) VALUES
(1, 'EG', '', 1),
(2, '1.OG', '', 1),
(3, '2.OG','', 1),
(4, 'EG', '',2),
...
-- Exportiere Daten aus Tabelle IIB2_UE2_Gruppe09.raum: ~9 rows
/*!40000 ALTER TABLE `raum` DISABLE KEYS */;
INSERT INTO `raum`(`rau_id`,`rau_nummer`, `rau_bezeichnung`,`rau_guid` , `rau_stw_id`) VALUES
(1, '0', 'H1/00', NULL, 1),
(2, '1', 'H1/10',  NULL,2),
(3, '2', 'H1/21',  NULL,3),
(4, '3', 'H1/22', NULL, 3),
...
-- Exportiere Daten aus Tabelle IIB2_UE2_Gruppe09.lnraumwand: ~36 rows (ungefähr)
